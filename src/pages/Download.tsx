              ...
              >
                <div className="cbw-card" style={{ padding: 22 }}>
                  ...
                  <div className="cbw-note" style={{ marginTop: 18 }}>
                    <strong>Hinweis:</strong> Wenn der Download nicht startet, prüfe bitte, ob die Datei
                    unter <span style={{ wordBreak: "break-all" }}> {APP_DOWNLOAD_URL}</span>
                    {" "}auf dem Hosting bereits vorhanden ist.
                  </div>
                </div>
                ...
                <div className="cbw-card" style={{ padding: 22 }}>
                  ...
                  >
                    ...
                    <li>Setup-Datei starten</li>
                    <li>Nach der Installation zurück zur App</li>
                  </ol>
